...
const Home = () => {
  ...
  return (
    <>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="rounded-[32px] bg-[#5B3A2E] border border-[#D9A441]/20 shadow-2xl px-10 py-16 md:px-20 text-center">
            ...
            <h2
              ...
              style={{ fontFamily: "Cardo, serif" }}
            >
              “Coffee is more than a drink—it's a quiet moment, a warm
              conversation, and the beginning of unforgettable memories.”
            </h2>
      ...
      <section className="bg-[#5B3A2E] py-24">
        ...
        <div className="overflow-hidden border border-[#D9A441]/20 shadow-2xl">
          <video
