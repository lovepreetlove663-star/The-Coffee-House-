        ...
        >
          ...
          <div className="relative flex items-center h-full px-8 md:px-16">
            <div className="max-w-2xl">
              <h3 className="text-lg font-semibold text-[#D9A441]">About Us</h3>
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-5 leading-8 text-[#DDD2CA]">
              ...
              next big idea, or simply taking a break, our café is a place where
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg leading-8 mt-5 text-[#DDD2CA]">
              Great coffee is only the beginning. We combine premium
              ingredients, skilled baristas, cozy interiors, and friendly
              service to create a space where every guest feels welcome,
