...
<section className="w-full bg-[#5B3A2E] px-6 py-24">
  <div className="max-w-4xl mx-auto text-center">
    ...
    <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-[#DDD2CA]">
      We're here to make every visit memorable. Reach out for reservations,
      events, collaborations, or simply to share your love for coffee.
    </p>
  </div>
</section>
...
<div className="text-center mb-16">
  ...
  <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-[#DDD2CA]">
    Have questions, feedback, or a special request? Fill out the form below,
    and our team at The Coffee House will get back to you as soon as possible.
  </p>
</div>
